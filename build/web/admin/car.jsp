                ...
                <div class="row mt-5 pagination">
                    <div class="col text-center">
                      <div class="block-27">
                        <ul>
                          <c:if test="${page != 1}">
                              <li><a href="admin-car?page=${page - 1}&car_name=${name}&color=${color}&district_id=${district_id}&car_brand_id=${car_brand_id}&car_type_id=${car_type_id}&seats=${seat}&transmission=${transmission}&priceFrom=${priceFrom}&priceTo=${priceTo}">&lt;</a></li>
                          </c:if>
                          <c:forEach begin="1" end="${totalPages}" var="i">
                                  <li class="link ${i == page ? "active" : ""}"><a href="admin-car?page=${i}&car_name=${name}&color=${color}&district_id=${district_id}&car_brand_id=${car_brand_id}&car_type_id=${car_type_id}&seats=${seat}&transmission=${transmission}&priceFrom=${priceFrom}&priceTo=${priceTo}">${i}</a></li>
                          </c:forEach>
